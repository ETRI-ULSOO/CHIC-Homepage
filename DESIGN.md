...
### ResultCard / ResultTable — 연구 결과물 38건
...
- **연차·대분류 필터 칩**을 상단에 고정 — 38건은 무한 스크롤로 훑기엔 많고 페이지네이션 하기엔 적다
- 이미지 없는 항목이 나올 수 있으므로 **이미지 부재 시 텍스트 전용 레이아웃**으로 자연 축약될 것

### KPI Stat

검증 수치(결과물 38건 · 아카이브 8,353장 · 데이터속성 92종/관계 14종 · 참여기관 7) 표시.
...
- **별도 페이지** — Results(38건, 필터), News(게시물 5건)
